...
<body>
	<div id="barraH">
		...
		<div id="opc2" class="botonB"></div>
		<div id="opc3" class="botonB"></div>
		<div id="opc4" class="botonB"></div>
		<div id="opc5" class="botonB"></div>
		<div id="opc6" class="botonB"></div>
		<div id="opc7" class="botonB"></div>
		<div id="opc8" class="botonB"></div>
	</div>
	<div id="vistaPrevia">
    <div class="tabs">
    <input checked id="one" name="tabs" type="radio">
    <label for="one">Panel 1</label>
    <input id="two" name="tabs" type="radio" value="Two">
    <label for="two">Panel 2</label>
    <input id="three" name="tabs" type="radio">
    <label for="three">Panel 3</label>
    <input id="four" name="tabs" type="radio">
    <label for="four">Panel 4</label>
    <div class="panels">
        <div class="panel">
            	<h2>Panel 1</h2>
